...
(function($) {
	...
	$("#c").click(function() {
		...
		s = s.replace(/<p>(\{\{\s*((?:MDCProjectPages|html5article)Toc|(?:css|CSSOM|dom)ref|(?:deprecated|non-standard|obsolete)_header|translationInProgress|翻訳中|outDated)\s*\}\})<\/p>/gi,'<div>$1</div>');
